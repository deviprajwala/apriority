...
struct two_itemset {
   int key1;
   int key2;
   struct two_itemset *link; //singly linked list with two keys in it
};
...
void init_matrix() //to get the input for the matrix
{
  int i,j;
...
int frequent_1itemset()//to find the items whose occurance is frequent ,i.e number of occurance is 
{                        //greater than the support count
...
void frequent_2itemset(int fk_size)//to find the pair items whose occurance is frequent,i.e number of 
{                                    //occurance is greater than the support count
...
void print() //to print the elements in the singly linked list
{
   two_item cur;
   cur = head;
...
void insertFirst(int key1, int key2) //function to insert elements into linked list
{
...
void frequent_3itemset()//to find the pair items whose occurance is frequent
{
  two_item cur;
...
void item(int x)//item number which corresponds to the item,here we have considered it in alphabetical 
{               //order
 if(x==1)
 {
  printf(" Beer ");
